...
const customerWebhook = async () => {
    await axios({
        url: "http://localhost:3000/data-manager/checkout/add",
        method: "POST",
        data:{
          workspaceId: 1,
          checkout:{
            ...
            "created_at": "2021-04-01T14:58:16-04:00",
            "updated_at": "2021-04-01T14:58:16-04:00",
            "landing_site": null,
            "note": null,
            "note_attributes": [
            ],
            ...
            "line_items": [
              {
                ...
                "key": "574a737dab2dffc3ed5eca5f1025a5bb",
                "destination_location_id": 938998193,
                "fulfillment_service": "manual",
                "gift_card": false,
                "grams": 454,
                "origin_location_id": 938998192,
